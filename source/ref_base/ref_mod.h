...
DECLARE_TYPEDEF_METHOD( void, R_GetDeviceInfo, char*, size_t );
...
struct ref_import_s {
	...
	R_GetDeviceInfoFn R_GetDeviceInfo;
};
...
void R_GetDeviceInfo( char *buffer, size_t buf_size ) { return ref_import.R_GetDeviceInfo(buffer, buf_size);  }
